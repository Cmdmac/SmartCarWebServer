...
function svg2json(svgPath, jsonPath) {
    fs.readFile(svgPath, (err, data) => {
        ...
        parser.parseString(data, (err, result) => {
            ...
            let categorys = [102, 100, 100, 100, 100, 102, 100, 100, 100, 100, 100];
            ...
            for (var i = 0; i < result.svg.g.g.path.length; i++) {
                ...
                if (p['fill-rule']) {
                    ...
                    let shop = {_id: Date.now(), Name: "block", name: "block", Name_en: "block", Center: [], Area: 0, BrandShop: 70000, Brief: "", Category: 102, ShoppNo: "", Brand: 1000, Type: 6001, Outline: [[points]], dianping_id: 0};
                    ...
                    shop.Category = categorys[floor.FuncAreas.length];
            ...
            result.svg.g.g.text.forEach(text => {
               ...
               if (item.fill === 'none') {
                   ...
                   const beacons = [
                        ...
                        {name: 'F', uuid: 222, mac: "45:c6:6a:c2:74:83", major: 19641, Minor: 10011, x: x, y: y},
                        {name: 'G', uuid: 222, mac: "45:c6:6a:c2:74:14", major: 19641, Minor: 10011, x: x, y: y},
                        {name: 'H', uuid: 222, mac: "45:c6:6a:c2:74:42", major: 19641, Minor: 10011, x: x, y: y},
                        {name: 'I', uuid: 222, mac: "45:c6:6a:c2:73:97", major: 19641, Minor: 10011, x: x, y: y},
                        {name: 'J', uuid: 222, mac: "45:c6:6a:c2:74:23", major: 19641, Minor: 10011, x: x, y: y}
                   ];
