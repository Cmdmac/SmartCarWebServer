        ...
        parser.parseString(data, (err, result) => {
            ...
            result.svg.g.g.text.forEach(text => {
               ...
               if (item.fill === 'none') {
                   ...
                   const beacons = [
                       {name: 'A', uuid: 222, mac: "2234:243:321:241", major: 2234, Minor: 2224, x: x, y: y},
                       {name: 'B', uuid: 222, mac: "2234:243:321:242", major: 2234, Minor: 2224, x: x, y: y},
                       {name: 'C', uuid: 222, mac: "2234:243:321:243", major: 2234, Minor: 2224, x: x, y: y},
                       {name: 'D', uuid: 222, mac: "2234:243:321:244", major: 2234, Minor: 2224, x: x, y: y},
                       {name: 'E', uuid: 222, mac: "2234:243:321:245", major: 2234, Minor: 2224, x: x, y: y}
                   ];
